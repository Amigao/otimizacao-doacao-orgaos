...
def heuristica_A_estrela(cidade, meta, coords):
...
def A_estrela(grafo, inicio, meta):
    ...
    open_set = []
    h_inicial = heuristica_A_estrela(inicio, meta, coordenadas)
    ...
    while open_set:
        ...
        for vizinho, custo in grafo.get(atual, []):
            ...
            h_vizinho = heuristica_A_estrela(vizinho, meta, coordenadas)
